...
from search_api.api.groups import validate_ui_groups
...
def test_all_ui_groups_defined():
    terms = [_term("title", "description"), _term("species", "subject")]
    groups = [_group("description"), _group("subject")]
    # Should not raise.
    validate_ui_groups(terms, groups, "fields.yaml")


def test_terms_without_ui_group_are_ignored():
...
def test_unknown_ui_group_raises():
...
def test_multiple_unknown_ui_groups_reported():
